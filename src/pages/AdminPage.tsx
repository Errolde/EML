  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button onClick={createPlayerAccount} className="flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-bold active:scale-95 transition-all"
          style={{ background: 'linear-gradient(135deg,#e8b84b,#c99a2e)', color: '#0a0f1a' }}>
        ...
        <div className="divide-y divide-white/[0.05]">
          {players.map(player => (
            <div key={player.id} className="flex items-center gap-3 px-4 py-3">
              ...
              <Select
                value={player.teamId || ''}
                onChange={v => assignToTeam(player.id, v)}
                options={teamOptions}
